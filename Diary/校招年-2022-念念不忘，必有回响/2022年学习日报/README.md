...
今天 没咋学 但是充分意识到自己的不足了orz 然后就是身体状态在慢慢提升 早睡了
...
- [x] 今天主任务——总结几个知识库的**知识体系**（的大体框架） 后期慢慢进行填补
  - [x] 下阶段努力方向：拥有良好的“写业务的能力” 然后再有更优秀的基础能力——锦上添花地工程师进阶内容（说得俗点 就是拿sp的能力~）
- [x] 复习promise 
- [x] 阅读React相关学习资料、书籍，阅读掘金上的优秀文章 整理React知识库——重点
- [x] 周总结
- [ ] `23:00` 每日睡前总结——刷题+工作内容+基础知识+明日展望
  - [ ] 另外就是一定要12点半前入睡！次日7:30前后起床，这很重要！
...
- [x] lc每日一题 今天是个动归 嘶~
- [ ] 今天主任务——总结几个知识库的**知识体系**（的大体框架） 后期慢慢进行填补
- [ ] CSS小册推进度-盒模型 总结layout知识库
- [ ] 阅读React相关学习资料、书籍，阅读掘金上的优秀文章 整理React知识库
- [ ] ES6学习，梳理JS知识库中的es6部分——拓展知识库
- [ ] 每日工作
