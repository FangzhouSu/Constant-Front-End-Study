...
- [x] 准备美团面试-看面经 然后查缺补漏
  - [ ] 手写题
  - [ ] 刷算法
  - [ ] JS经典问题（JS灵魂之问） CSS经典问题 
  - [ ] 研究浏览器进程线程问题 阅读https://juejin.cn/post/6844903553795014663 - 学习浏览器内核中线程之间的关系~
...
- [ ] 准备美团面试-看面经 然后查缺补漏
  - [ ] 学习async promise 多写代码
  - [ ] 节流防抖 写代码！
  - [ ] 手写题 数组去重-遍历去重 开辟新空间 数组扁平化
  - [x] 刷算法 快排
  - [ ] JS经典问题（JS灵魂之问） CSS经典问题 
  - [ ] 研究浏览器进程线程问题 阅读https://juejin.cn/post/6844903553795014663 - 浏览器渲染流程
- [ ] lc每日一题
- [x] 每日工作 工作提效！
