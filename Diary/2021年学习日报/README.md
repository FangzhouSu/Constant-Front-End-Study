...
下午效率爆炸了 打王者上头…无极鲅鱼 项目要准备开工了！肝起来！
...
// 从早上-中午 拿出一整块时间学习前端基础 晚上跑完步回来继续看~
    1.1 前端基础学习 20min 
    // 红宝书、刷题
		/* 复习了个CSS小知识 text-decoration无法继承 默认值为none 但是如果镶嵌在p中的一个行内元素就会被跨过去一样地加上，可以将不需要下划线的子元素改为 行内块级标签 即可
		决定之后看看你不知道的JS~
        */
    1.2 JS 30demos min
    	/*  */
...
2.核心基础知识 下午开始学计网 + 刷题
	2.1 计网 30min
		/* Cookie帮助无状态的HTTP协议保存用户状态，服务端在响应报文中发送生成的copkie信息 之后客户端的请求报文中携带这个信息就可以直接登录了~ */
	2.2 操作系统 min
		/*  */
...
4.前端开发框架 
	4.1 react&Vue学习 30+180min
		/* 看看基础知识+初识组件项目
        入门Vue脚手架，跟React有几分相似哈~*/
    4.2 项目开发 min
    	/*  */
5.其他 
6.每日总结 & 第二天学习规划预告 30min
```
...
#### [如何去除子元素从父元素“继承”的下划线](https://blog.csdn.net/qq_44960253/article/details/106972959)



## 2.计网

![image-20211101153655547](https://gitee.com/su-fangzhou/blog-image/raw/master/202111011536786.png)

![image-20211101174009391](https://gitee.com/su-fangzhou/blog-image/raw/master/202111011740682.png)
...
项目进度的推进速度还蛮快 负责人建议明天开始着手编码了，那我们再加快点速度咯！
...
1.前端基础知识
    1.1 前端基础学习 20min 
    // 红宝书、刷题
		/* 项目中正好碰到了，学习下async await实现异步操作，简化promise的写法，让方法看起来更像同步一些~
        */
    1.2 JS 30demos min
    	/*  */
...
4.前端开发框架 
	4.1 react&Vue学习 260min
		/* 继续搞支持中心项目的一些细则，书里写了很多优化的点
        项目构建与开发入门*/
    4.2 项目开发 120min
    	/* 维护一下线上仓库，熟悉一下各个文件夹，简单把任务切一下
        继续推进项目完成进度，啊这 明天要开始搞项目了*/
5.其他 
	操作系统作业 40min
```
...
- 项目实战看到p209 优化的东西蛮多的，先少关注一些细节吧，先“会写”，再考虑“怎么写好”

## 4.LeetCode

- 今天的[接雨水II hard](https://leetcode-cn.com/problems/trapping-rain-water-ii/solution/407-jie-yu-shui-ii-yan-du-you-xian-sou-s-ysnh/)不算自己写的。BFS+最小堆的思想
...
4.前端开发框架 
    ...
    4.2 项目开发 260min
    	/* 梳理一下项目的大框架 */
5.其他 
	了解本科生前端开发校招前景，认识了一个大厂收割机的直系学长，聊了一下，信心++（学长说成电计算机学院搞前端的几个同学平均都拿到几个大厂offer 酱紫）所以之后更勇敢地冲冲冲！ 40min
    和浙大哥们儿聊了下面试的内容 20min
```
...
![image-20211104171630872](https://gitee.com/su-fangzhou/blog-image/raw/master/202111041716317.png)
...
>
> ![image-20211104171705908](https://gitee.com/su-fangzhou/blog-image/raw/master/202111041717042.png)



 `indexOf()`方法的时间复杂度探讨

> 这个没搜到 大概是N的时间复杂度吧~遍历一趟吗 参考的MDN
...
但是今天整体效率太低下勒！今天早些睡明天一定要全力搞项目了！页面弄出来点！！
...
- [1218. 最长定差子序列](https://leetcode-cn.com/problems/longest-arithmetic-subsequence-of-given-difference/)又是抄官方题解的一天。赶紧学动归呐！一看见就退缩可不行！关键就是那个状态转移方程！
