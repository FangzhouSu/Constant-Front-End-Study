...
> 新的开始 
>
> 这一个月过去了 也没能开始疯狂面试哈~来了个项目，先做好这个项目，充实下项目经历吧！
...
1.前端基础知识
    ...
    1.1 前端基础学习 30min 
    // 红宝书、刷题
		/* 复习下数组去重 拓展了解了更多内容（sort内置API的时间复杂度（与JS引擎&p有关）） */
    1.2 JS 30demos min
    	/*  */
...
1.前端基础知识
    1.1 前端基础学习 30min 
    // 红宝书、刷题
		/* 看了些函数作用域的知识，函数中的this指针是指向window的（如果直接在全局调用的话，因为谁调用这个函数，this指针就指向谁！） */
    1.2 JS 30demos min
    	/*  */
...
3.面试刷题
	3.1 刷算法 刷力扣 60min	
    	/* 掘金小册 11/28
        	每日一题做歪了之后看眼答案的思路恍然大悟。。。二维数组特容易绕道弯儿里去
        	简单方法做了道经典题*/   
    	// 每个阶段结束后 简单总结下应对某种数据结构/对应类型的题目 应该怎么去想
        1.数组 + 字符串 + 链表 + 二叉树 + 栈/队列 熟练掌握这些数据结构
        2.双指针 + 遍历专题DFS BFS + 递归
...
4.前端开发框架 
	4.1 react&Vue学习 20min
		/* 学习了下Vuex，了解下在mock文件夹中写一些假数据来让前端收到 */
    4.2 项目开发 200min
    	/* 讨论下接下来的项目要咋做，云托管平台折腾一下
    	完善下自己这边项目的代码，但是云托管平台还是有问题！子分支克隆下来之后还是有问题。。这个master分支给我整蒙了 到底是我的master分支还是整个的master分支啊~ 另外代码push不到自己的分支
        */
5.其他  map
```
